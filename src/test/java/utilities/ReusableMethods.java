...
public class ReusableMethods {
    ...
    static JavascriptExecutor javascriptExecutor =(JavascriptExecutor) Driver.getDriver();
    ...
    public static void textGorunuyorMu(String text){
        WebElement element= getDriver().findElement(By.xpath("//*[text()='"+text+"']"));
        assertTrue(element.isDisplayed());
    }
    public static WebElement textIleElemanBulma(String text){
        WebElement element= getDriver().findElement(By.xpath("//*[text()='"+text+"']"));
        return element;
    }

    public static void istenenKadarKaydirna(int yatayYon, int dikeyYon){
        javascriptExecutor.executeScript("window.scrollBy("+yatayYon+","+dikeyYon+")");
    }
    public static void elementeKadarKaydirma(String elementText){
        javascriptExecutor.executeScript("arguments[0].scrollIntoView();",ReusableMethods.textIleElemanBulma(elementText));
        istenenKadarKaydirna(0,-200);
    }
